  ...
  return (
    <div className="relative flex flex-col flex-1 items-center justify-center min-h-screen bg-[#0d0d0f] text-white px-6 font-sans">
      ...
      <div className="relative w-full max-w-md p-8 sm:p-10 rounded-3xl bg-zinc-900/80 border border-zinc-800 shadow-2xl shadow-[#EB0A1E]/5 backdrop-blur-md z-10">
        ...
        {/* Title */}
        <div className="mb-6">
          <span className="text-xs font-bold tracking-[0.2em] text-[#EB0A1E] uppercase">Dealership Sales Performance</span>
          <h2 className="text-3xl font-black tracking-tight text-white mt-1">Officer Login</h2>
          <p className="text-sm text-zinc-400 mt-2">
            Enter your credentials to log sales volume and track real-time incentives.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. officer@toyota.com"
              required
          ...
          >
            {loading ? "Authenticating Officer..." : "Access Sales Portal"}
          </button>
        </form>
        ...
        <div className="mt-8 text-center text-xs text-zinc-500 border-t border-zinc-800/80 pt-6">
          ...
          <Link href="/login/admin" className="font-semibold text-white hover:text-red-400 transition-colors duration-300">
            Sign in here
          </Link>
        </div>
